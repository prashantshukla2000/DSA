class Solution {
    ...
    public String multiply(String num1, String num2) {
        ...
        StringBuilder buildResponse = new StringBuilder();//creatingthe strig of the actual no..after the leading zeroes
    ...
    private String reverseString(String str) {//to reverse the string
        StringBuilder reversedStr = new StringBuilder(str);
        reversedStr.reverse();
        return reversedStr.toString();
    }

    private void reverseArrayInPlace(int[] arr) {//to reverse the array
